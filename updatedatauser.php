                    ...
                    <table class="table table-bordered">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a type="button" class="btn btn-info btn-xs edit_data" data-toggle="modal" data-keyboard="false" data-backdrop="static" data-target="#update_data" data-id="<?= $row['id']; ?>" data-title="<?= $row['title']; ?>" data-enable="<?= $row['enable']; ?>" data-description="<?= $row['description']; ?>" data-type="<?= $row['type']; ?>">Edit</a></td>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1"> Enable</label>
                        <input class="form-control" id="enable1" name="enable1" rows="3">
                    </div>
